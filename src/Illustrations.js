export function Illustrations() {
  return (
      <div className='illu-container'>
          ...
          <img src="https://startbootstrap.github.io/startbootstrap-sb-admin-2/img/undraw_posting_photo.svg" alt="illu-image" />
          ...
          <a style={{ padding: "15px" }} href="https://undraw.co/" target="_blank">Browse Illustrations on unDraw➡</a>
      </div>
  );
}